...
<?php
/**
 * Vantage Markets — Missing PHP Action Handlers
 *
 * Paste these functions into your main api.php and add the
 * corresponding case entries to the switch($action) block.
 *
 * ─── Switch additions ─────────────────────────────────────────────────────────
 *
 *   case 'get_signals':
...
// ─── Decode the base64 token and return the user_id ───────────────────────────
