...
const timeline = [
  { year: "2009", title: "ABle Markets Founded", desc: "Started with a small team in Australia focused on providing transparent forex trading to retail traders." },
  ...
  { year: "2024", title: "5 Million Traders", desc: "Reached the 5 million registered user milestone. Launched the ABle proprietary app and TradingView integration." },
    ...
    <PublicLayout>
      ...
      <section className="pt-20 pb-16 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-10 relative z-10">
          ...
          <h1 className="font-display font-extrabold text-5xl text-white mb-4 leading-tight">
            About <span className="text-accent-light">ABle Markets</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start mb-20">
            <div>
              ...
              <p className="text-[#4A5568] leading-relaxed mb-4">
                ABle Markets was founded with a single mission: to democratise access to global financial markets for every trader, whether they are based in Lagos, Nairobi, Johannesburg, or London.
              </p>
              <p className="text-[#4A5568] leading-relaxed mb-4">
      ...
      <section id="regulation" className="py-20 bg-surface">
        <div className="max-w-[1200px] mx-auto px-10">
          <SectionHeader
            ...
            subtitle="ABle Markets operates under strict regulatory oversight across multiple jurisdictions — ensuring the highest standards of client protection."
            center
          />
          ...
          <div className="bg-white border border-surface-border rounded-[12px] p-5 text-xs text-[#8897A9] leading-relaxed">
            VIG Group, operating under the brand ABle Markets, is an investment dealer authorised and regulated by the Mauritius Financial Services Commission (FSC). Business operations are protected by insurance coverage provided by Willis Towers Watson (WTW), a global insurance brokerage established in 1828. This coverage includes claims eligibility of up to USD 1,000,000 per claimant. ABle Markets is a member of The Financial Commission, an international organisation engaged in the resolution of disputes within the financial services industry.
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-10">
          ...
          <div className="relative pl-10 border-l-2 border-gradient" style={{ borderImage: "linear-gradient(to bottom, #E8500A, #00B4A6) 1" }}>
