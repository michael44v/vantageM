      ...
      <section className="pt-20 pb-16 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-10 relative z-10">
          ...
          <h1 className="font-display font-extrabold text-5xl text-white mb-4 leading-tight">
            ...
            <span className="text-gold">ABle Partner Program</span>
          </h1>
          <p className="text-lg text-white/55 max-w-xl">
            Join thousands of IBs and affiliates earning generous commissions by referring clients to ABle Markets.
          </p>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="p-12">
                ...
                <p className="text-white/55 leading-relaxed">
                  Use our interactive calculator to see how much you could earn as an ABle Markets IB based on your referral volume and client activity.
                </p>
              </div>
