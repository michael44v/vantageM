...
const allPromos = [
  ...
  {
    id: "rewards",
    title: "vāntãgeCFD Rewards Program",
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-10">
          ...
          <div className="mt-10 bg-surface border border-surface-border rounded-[12px] px-5 py-4 text-xs text-[#8897A9] leading-relaxed">
            ...
            All promotions are subject to vāntãgeCFD terms and conditions. Bonuses may carry trading volume requirements before withdrawal is permitted. Promotions cannot be combined unless explicitly stated. vāntãgeCFD reserves the right to modify or withdraw any promotion at any time without prior notice. Please read the full terms on each promotion page before participating.
          </div>
        </div>
      </section>
    </PublicLayout>
