      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full text-left text-[11px] min-w-[640px]">
          <thead className="bg-white/5 sticky top-0">
            <tr>
              {["#", "Symbol", "Type", "Lots", "Entry", "Close", "P&L", "Opened", "Closed"].map((h) => (
                <th key={h} className="px-3 py-2 text-white/30 font-bold whitespace-nowrap">{h}</th>
              ))}
            </tr>
          </thead>
                      ...
                      return (
                        <tr key={p.id} className="hover:bg-white/5">
                          ...
                          <td className="px-3 py-2.5 font-mono">
                            {parseFloat(p.entry_price).toFixed(5)}
                          </td>
                          <td className="px-3 py-2.5 font-mono">
                            {parseFloat(p.current_price).toFixed(5)}
                          </td>
                          <td className={`px-3 py-2.5 font-mono font-bold ${pnl >= 0 ? "text-emerald-400" : "text-red-400"}`}>
                            {pnl >= 0 ? "+" : ""}${pnl.toFixed(2)}
                          </td>
                          <td className="px-3 py-2.5 text-right">
                            <button
                              ...
                              className="px-2 py-1 rounded bg-red-500/10 hover:bg-red-500/25 text-red-400 font-bold transition-colors disabled:opacity-40 flex items-center gap-1 ml-auto"
                            >
                              {closingId === String(p.id)
